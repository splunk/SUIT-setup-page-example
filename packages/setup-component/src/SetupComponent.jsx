...
async function createPassword(password) {
    ...
    fetchInit.method = 'POST';
    const realm = 'dsfsdwdawdawasdasdfsdfdsdsf';
    const user = 'nusairhaqnusairhaq';
                            ...
                            <ColumnLayout.Row>
                                <ColumnLayout.Column span={6}>
                                    <div className="left">
                                        ...
                                        configuration so that it can perform the functionality it
                                        was designed for. This can include: saving user-provided
                                        configuratiions in .conf files, integrating with external
                                        services through REST API and checking for app dependencies.
                                        <br />
                                        <br />
                                        ...
                                        <List>
                                            ...
                                            <List.Item>
                                                ...
                                                <List style={{ margin: 0 }}>
                                                    <List.Item>
                                                        Creates and encrypts the API key, resulting
                                                        in a new passwords.conf stanza.
                                                    </List.Item>
                                                </List>
                                            </List.Item>
                                        </List>
                                        In some cases, you can even introduce custom setup options
                                        and parameters, which would require an additional file. For
                                        example, if you wanted the user to specify an API Key.
                                        <List>
                                            <List.Item>
                                                setup_view_example.conf
                                                <List style={{ margin: 0 }}>
                                                    <List.Item>
                                                        Creates a custom conf file to manage Splunk
                                                    ...
                                                    <List.Item>
                                                        ...
                                                        [example_stanza] and assigns the `API URL`
                                                        to it
                                                    </List.Item>
                                                </List>
                                            </List.Item>
                                ...
                                <ColumnLayout.Column span={6}>
                                    <div className="right">
                                        ...
                                        developer tools. This app utilizes the new Splunk UI
                                        Toolkit, allowing for consistent visual components and
                                        responsive app interaction with ReactJS packages.
                                        <br />
                                        ...
                                        <List>
                                            <List.Item>
                                                ...
                                                <List style={{ margin: 0 }}>
                                                    <List.Item>
                                                        Generates the entire Splunk App, allowing
                                                        for easy creation of a cloud ready Splunk
                                                        App with ReactJS
                                                    </List.Item>
                                                </List>
                                            </List.Item>
                                            ...
                                            <List.Item>
                                                ...
                                                <List style={{ margin: 0 }}>
                                                    <List.Item>
                                                        ...
                                                        endpoints. Used to update specified conf
                                                        files and generate helper functions for the
                                                        workflow of the setup page
                                                    </List.Item>
                                                </List>
                                            </List.Item>
                                        </List>
